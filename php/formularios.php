...
<ul>
 ...
 <b></b> <li><a href="InicioS.php">Inicio</a></li>
 ...
 <li><a href="NServicio.html">Servicio</a></li>
  ...
  <li><a class="active" href="formularios.php">Formularios recibidos</a></li>
  <li><a href="updSer.php">Editar publicación</a></li>
  <li><a href="eliSer.php">Eliminar publicación</a></li>
  <li><a href="Conocenos.html">Acerca de NetSale</a></li></b>
...
<div class="navbar">
  ...
  <div class="dropdown">
    ...
    <div class="dropdown-content">
      <a href="InicioOs.php">Aspecto Oscuro <img src="https://image.flaticon.com/icons/png/512/61/61412.png" alt="Logo" width="15" height="15"></a>
...
<div style="margin-left:25%;padding:50px 16px;height:500px;">
...
<?php
  ...
  $sql = "SELECT nombre, descripcion, horario, celular, ubicacion, paquete, image FROM formulario";
  ...
  if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
      ...
      echo '<div class=card><b>Status:</b> Pagado<p></p>'.' <img src="data:image/jpeg;base64,' . base64_encode( $row['image'] ) . '" /alt="imagen" width="400" height="250"></a><b>'."   ";
      echo "<p></p><div class=col-lg-8 col-sm-7><form action=NS.php method=post>";
      echo "<p></p>";
      ...
      <input type=text class=form-control name=ho  value=".$hor." />
      <input type=text class=form-control name=cel  value=$row[celular] />
      
      <input type=text class=form-control name=paquete  value=$pa />
        ...
        <p></p>
          ...
          <button type=submit name=clavess style=background-color:black id=add-to-cart onclick=Inicio.php class=btn btn-adc btn-block adc-button value=". "" .">Publicar</button>
              </form>
         </div>";
