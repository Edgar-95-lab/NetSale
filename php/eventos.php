...
<ul>
 ...
 <b></b> <li><a href="CInicioS.php">Inicio</a></li>
 <b><li><aa>Categorías</aa></li></b>
  <li><a href="comida.php">Comida</a></li>
  <li><a class="active" href="eventos.php">Artesanías</a></li>
  <li><a href="otros.php">Otros</a></li>
 <b><li><aa>A cerca de NetSale</aa></li></b>
 <li><a href="contacto.html">Contáctanos</a></li>
 <li><a href="paquetes.html">Paquetes</a></li>
  <li><a href="Efor.html">Enviar formulario</a></li>
  </b>
...
<div class="navbar">
  ...
  <div class="dropdown">
    ...
    <div class="dropdown-content">
      <a href="CInicioOsS.php">Aspecto Oscuro <img src="https://image.flaticon.com/icons/png/512/61/61412.png" alt="Logo" width="15" height="15"></a>
      ...
      <a href="Prueba.html">Cerrar Sesión <img src="https://c0.klipartz.com/pngpicture/475/85/gratis-png-iconos-de-computadora-cierre-de-sesion.png" alt="Logo" width="15" height="15"></a>
    </div>
  </div> 
  <a class="active" href="#news" style="float:left"> Servicios</a>
  <a href="CInicio.php" style="float:left"> Productos</a>
</div>
...
<div style="margin-left:25%;padding:50px 16px;height:1000px;">
  ...
  $sql = "SELECT id_servicio, titulo, descripcion, celular, telefono, ubicacion, link, correo, horario, contador, categoria, image FROM servicios where categoria='artesanias' order by fecha DESC";
  ...
  if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
      ...
      echo '<div class=card><a href="'.$link.'">'.' <img src="data:image/jpeg;base64,' . base64_encode( $row['image'] ) . '" /alt="imagen" width="400" height="250"></a><b>'."   "."<a href=".$whats."> "."
      Contáctanos a través de".' </b><img src=https://es.logodownload.org/wp-content/uploads/2018/10/whatsapp-logo-11.png width=45 height=45>'.'</a>'."  &nbsp;&nbsp; "."<a href="."https://www.facebook.com/pages/creation/?ref_type=facebook_business_website"."> "."<img src=https://upload.wikimedia.org/wikipedia/commons/thumb/5/51/Facebook_f_logo_%282019%29.svg/1365px-Facebook_f_logo_%282019%29.svg.png width=45 height=45></a>"."   &nbsp;&nbsp; "."<a href="."https://business.instagram.com/advertising"."> "."<img src=https://i.pinimg.com/originals/3b/21/c7/3b21c7efd2ba9c119fb8d361acacc31d.png width=45 height=45></div></a>";

      echo "<p></p>".$row['descripcion'];

      echo "<p></p><div class=col-lg-8 col-sm-7><form action=CScomentarios.php method=post>
      <a href=CSpago.html>
      ...
      echo "<h5><p></p> <p> Celular: " . $row["celular"]."Telefonos: Línea fija:".$row["telefono"]. " o contáctanos a través de WhatsApp, Correo: " . $row["correo"]. " </p></h5> <h4><a href=" . $dir . "><img src=ubica.png width=30 height=30>".$row['ubicacion']."</a><br></h4>";
      echo "<b>Nivel de satisfacción:</b><p></p><b>
      <form action=up5.php method=post enctype=multipart/form-data>
      ...
      <button  type=submit name=submit style=background-color:gray id=add-to-cart onclick=Inicio.php class=btn btn-adc btn-block adc-button value=".$id.">Buen servicio</button>
          </form><p></p><form action=up6.php method=post>
