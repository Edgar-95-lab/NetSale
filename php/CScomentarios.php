...
<ul>
 ...
 <li><a href="NServicio.html">Paquetes</a></li>
  <li><a href="NPublicacion.html">Enviar formulario</a></li></b>
...
<div style="margin-left:25%;padding:50px 16px;height:100px;">
...
//$sql = "SELECT id_servicio, titulo, descripcion, celular, telefono, ubicacion, link, correo, horario, contador, image FROM servicios";
  ...
  if ($result->num_rows > 0) {
    ...
    echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
    echo "<p></p><div class=col-lg-8 col-sm-7><form action=crear.php method=post enctype=multipart/form-data>
