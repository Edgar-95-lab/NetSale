...
<body>
      ...
      <div class="container">
        <div class="login-container">
          <div class="register">
            ...
            <form action="AbuscarS.php" method="post" enctype="multipart/form-data">
              <input type="text" class="form-control" name="id" placeholder="Identificador del servicio" required>
  ...
  $sql = "SELECT id_servicio, titulo, fecha, image FROM servicios order by fecha DESC";
  ...
  if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
      echo "<div class=headersub><h3>Identificador: $row[id_servicio]   " . $row["titulo"]. "</h3> <p></p></div> <h4> " . " </h4>" . "<br>";
