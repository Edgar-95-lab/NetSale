...
<div class="container">
	...
	echo "<div class='alert alert-warning mt-4' role='alert'>
					<p>Usuario y correo existente.</p>
					<p><a href='CNueva.html'>Registrarse de nuevo</a></p>
				</div>";
	} else {	
	...
	*/
	...
	if (mysqli_query($conn, $query)) {
		...
		<a class='btn btn-outline-primary' href='Inicio.php' role='button'>Aceptar</a></div>";	
		echo "<div class='alert alert-success mt-4' role='alert'><h3>Tu cuenta ha sido creada con éxito.</h3>
		<a class='btn btn-outline-primary' href='CInicio.php' role='button'>Aceptar</a></div>";	
		} else {
