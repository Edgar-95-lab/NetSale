...
<ul>
 ...
 <b><li><aa>Categorías</aa></li></b>
  <li><a href="Epublicacion.html">Tecnología</a></li>
  <li><a href="Elipublicacion.html">Ropa y calzado</a></li>
  <li><a href="Acercade.html">Otros</a></li>
 <b><li><aa>A cerca de NetSale</aa></li></b>
 <li><a href="NServicio.html">Contáctanos</a></li>
 <li><a href="NServicio.html">Paquetes</a></li>
  <li><a href="NPublicacion.html">Enviar formulario</a></li>
  </b>
...
<div class="navbar">
  ...
  <a href="CInicioS.php" style="float:left"> Servicios</a>
  <a class="active" href="Inicio.php" style="float:left"> Productos</a>
</div>
...
<?php
  ...
  if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
      echo "<div class=headersub><h2>" . $row["nombre"]. "</h2> <p></p></div> <h4>Nuevo producto disponible, " . $row["fecha"]. " </h4>" . "<br>";
      echo '<a href="compra.php"> <img src="data:image/jpeg;base64,' . base64_encode( $row['image'] ) . '" /alt="imagen" width="400" height="300"> </a>'."<a href="."https://api.whatsapp.com/send?phone=524121200630&fbclid=IwAR3407BMqzO-02FFbRloPtEko16mMNqDpTXD_HOa05BMPfSITu-QBNI69fc"."> "."
      Contáctanos a través de".' </b><img src=https://es.logodownload.org/wp-content/uploads/2018/10/whatsapp-logo-11.png width=45 height=45>'.'</a>'.'<div class="quantity mr-sm-2 mr-0 mb-sm-0 mb-2"><a href="paypal.php">
      
      </a></div>';
      echo "<p></p><div class=col-lg-8 col-sm-7>
      <a href=ppago.html>
        ...
        <a href=comentarios.php>
         <input type=button style=background-color:black id=add-to-cart onclick=Inicio.php class=btn btn-adc btn-block adc-button value=Comentarios />
         </a>
         </div>";
      echo "<h2> $ " . $row["precio"]. "</h2> <h5><p></p> <p>" . $row["descrip"]. ", Stock disponible: " . $row["stock"]. " </p></h5> <h4>" . $row["origen"]. "<br></h4>
      ";
    }
  } else {
    echo "0 results";
