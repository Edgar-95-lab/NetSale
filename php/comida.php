...
<ul>
 ...
 <b><li><aa>Categorías</aa></li></b>
  ...
  <li><a href="eventos.php">Artesanías</a></li>
...
<div style="margin-left:25%;padding:50px 16px;height:1000px;">
  ...
  $sql = "SELECT id_servicio, titulo, descripcion, celular, telefono, ubicacion, link, correo, horario, contador, categoria, image FROM servicios where categoria='comida' order by fecha DESC";
